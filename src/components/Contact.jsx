      ...
      <div className="container lg:grid lg:grid-cols-2 lg:items-stretch">
        <div className="mb-12 lg:mb-0 lg:flex lg:flex-col">
          ...
          <p className="text-zinc-400 mt-3 reveal-up mb-8 max-w-[50ch] lg:max-w-[30ch]">
            همین امروز با ما تماس بگیرید تا در مورد نیازهای پروژه شما صحبت کنیم
            و همکاری در مورد چیزی شگفت‌انگیز را آغاز کنیم
          </p>
        ...
        <form
          method="POST"
          action="https://getform.io/f/bllqyvlb"
          ...
          <div className="md:grid md:items-center md:grid-cols-2 md:gap-2">
            <div className="mb-4 ">
              ...
              <input
                ...
                autoComplete="name"
                required
                placeholder="مثلاً : محمد یاسین موحدی"
